<%@ Page Title="" Language="C#" MasterPageFile="~/customerMaster.master" AutoEventWireup="true" CodeFile="Payment - Copy.aspx.cs" Inherits="Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <asp:RequiredFieldValidator ID="RequiredFieldValidator9"
      ControlToValidate="customerIDTB" runat="server" ErrorMessage="Please Enter Your Full Name"
      Style="color: #FF0000"></asp:RequiredFieldValidator>
           </td>
       </tr>
       <tr>
